...
description: "All 9 Steam achievements — First Day through Traitors, with global unlock rates and 100% route."
game: animaly-bar-no-humanity
slug: achievements
topic: collectibles
date: "2026-09-17"
updated: "2026-09-17"
quickAnswer: "9 total — story four auto; Artwork + Good Guess on Festival; Time to Go / Knock Knock / Traitors need planned shoot-or-spare runs."
---

# Animaly Bar: NO HUMANITY — All Achievements

**Nine** Steam achievements. First four = normal story. Middle two = Festival side stuff. Last three = hard shoot/spare branches — tie to [Endings](/animaly-bar-no-humanity/endings).

## Jump to

- [Achievement overview](#achievement-overview)
- [100% route](#100-route)
- [Achievement: First Day](#achievement-first-day)
- [Achievement: First Sale](#achievement-first-sale)
- [Achievement: First Kill](#achievement-first-kill)
- [Achievement: Looters](#achievement-looters)
- [Achievement: Artwork](#achievement-artwork)
- [Achievement: Time to Go](#achievement-time-to-go)
- [Achievement: Good Guess](#achievement-good-guess)
- [Achievement: Knock Knock](#achievement-knock-knock)
- [Achievement: Traitors](#achievement-traitors)
...
- Do not kill or interrupt the humans; let them do what they are supposed to do.
...
- Identify the humans in disguise: Day 1: Panda, Cat, Turtle, Bull; Day 2: Owl, Horse, Hedgehog, Bunny; Day 3: Wolf, Eagle, Chicken, Kangaroo, Elephant.
- Kill each of these characters without killing any animals.
