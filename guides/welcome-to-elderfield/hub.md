...
- **Mines** — Molly, Pickaxe, Furnace, [bronze smelting](/welcome-to-elderfield/cooking-and-crafting)
- **Library** — Professor Dayton, Zartekch lore
- **Mall / Sewers** — Pete, god shrines, [Ghost Blast](/welcome-to-elderfield/ritual-skills-reference)
- **Residential** — [Clear Tentacles](/welcome-to-elderfield#clear-tentacles--adrian) (Adrian), Akira mysteries
- **Mid-game** — [God rooms](/welcome-to-elderfield/god-rooms), [key locations](/welcome-to-elderfield/key-locations), [Ancient Crystal](/welcome-to-elderfield#ancient-crystal--molly), Joggers Club
- **Optional** — [Side quests](/welcome-to-elderfield/side-quests), [fishing](/welcome-to-elderfield/fishing)
- **Events** — [Moon events](/welcome-to-elderfield/moon-events) (Blood / Strange / Night Terrors)
- **Combat** — [Boss fights](/welcome-to-elderfield/boss-fights-and-elites) when ready
...
| Rituals | [Full reference](/welcome-to-elderfield/ritual-skills-reference) |
| God rooms | [Daeus, Gatis, Nezroth, Delvek](/welcome-to-elderfield/god-rooms) |
| Cooking & crafting | [Food, furnace, farm tools](/welcome-to-elderfield/cooking-and-crafting) |
...
Difficulty is locked here unless you use Custom later.

- Pick **Normal** as baseline — 5% gold lost on death, encounters reset, you return home
- Enable intro cutscene + tutorial (combat points matter from minute one)
- Customize look, confirm, start
...
## Old Woods — Tutorial Fight

Scripted fight against Zartekch Cultist / Imperfect Creation. Teaches the whole combat loop.

- Watch AP symbols — one action per point per turn
- Open with **Precision Strike** (generates combat points)
- Use **Swift / Lethal / Defensive** points for dodge, crit, heal
- Eat food when HP drops — empty food bar = most common early death
...
## First Night — Bath and Sleep

Race home after the woods fight.

- **Bath** — full HP/MP, clears blessings and curses, **also respawns all monsters and resets mysteries**
- **Sleep** after 6:00 PM → 6:00 AM, saves progress
- Read bookshelf note → journal entry
- TV news = event hints
- Pizza recipe unlocked: Bread, Cooked Meat, Red Mushroom, Bitter Herb, Secret Sauce
...
Best early food: [Vegetable Soup](/welcome-to-elderfield/cooking-and-crafting) (Bitter Herb + Red Mushroom, 20 HP).

## Hans Farm — Main Quest Starts

Talk to **Tanner** → west to Hans Farm.
...
3. Use balm on ghost tentacles → till → plant → water nightly
4. Scarecrow reduces crow losses
...
Main story flag once farming starts:
...
## Mines — Molly's Workshop

Tanner unlocks gate below Old Woods → **Tanner's cabin** → Molly.
...
3. Smelt 1 Copper + 2 Coal → **Bronze Bar**

Furnace = biggest early power spike. Details: [smelting and crafting](/welcome-to-elderfield/cooking-and-crafting).

### Ancient Crystal — Molly

Side quest from **Molly** after the workshop opens:

1. **Mall mine floor 1** — talk to Molly's friend the **Shopping Rat**, buy **Normal Pickaxe** (**150 gold**)
...
Elderfield Public Library maze (layout shifts weekly).

- **Professor Dayton** — **far east end** of the library (see [Stone Tower Mystery](#stone-tower-mystery))
- Same trip: [Energizing Blast](/welcome-to-elderfield/ritual-skills-reference), [Treasure Map 3](/welcome-to-elderfield/treasure-map-3-from-alice) if Alice flagged it

## Pete — In God's Name

Apartment **basement** laundry → **Pete the Laundry Ghost**.

Quest **In God's Name**:

1. Accept from Pete
2. Pray at **two different god shrines** — one in the **Mall**, one in the **Sewers**
3. Return to Pete → **Ghost Blast** ritual

Track stacks: [blessings and curses](/welcome-to-elderfield/blessings-and-curses). Hans Farm loop: [small god shrine prayer](/welcome-to-elderfield/small-god-shrine-prayer).

## Clear Tentacles — Adrian

Apartment **1F** — **Adrian** (tentacles bursting through his wall).

1. Talk to Adrian → **food court back office key**
2. **Food court** — door **beside the merchant** into the back corridor (**curse debuff** on entry — stats drop)
...
6. Return to the pond — **fight the administrator again** → **skull** reward; **southeast tentacle clears** (loot inside)
7. Back to Adrian on **1F** → **Normal Axe**

Next day: letter → [Clear Broken Branches](/welcome-to-elderfield/side-quests) (Old Woods). Opens mall mines / [god rooms](/welcome-to-elderfield/god-rooms) when combined with mall keys.

## Akira — Time of Mysteries

Apartment **2F** — **Akira**.

1. Accept first task → complete **any mystery**
...
| Method | Effect |
| --- | --- |
| Bath at home | Full HP/MP, clears most blessings/curses, respawns world |
| Soul Moon at midnight | Full HP/MP + clear effects when it appears |
| Restore Potions / Holy Water | Target specific curse or add blessing |
| Tax curses (Carrion, Blight, Tax Plague) | **Do not wash off** until Tax Man returns |

[Heavy Eyelids](/welcome-to-elderfield/blessings-and-curses) cuts EXP ~15% — sleep to clear, bathing won't help.

## Joggers Club and Keys

Join **Joggers Club** → paths to **Old Wood Mine** + hidden location.
...
- Treasure rooms match your chosen Old One — full routes: [Daeus, Gatis, Nezroth, Delvek](/welcome-to-elderfield/god-rooms)

## Mine Progression

1. Clear Mall mine (first level)
2. Talk to **Shopping Rat** → Old Wood Mine info
3. Old Wood = second mine, better ore — bring food, watch falling debris

Materials: [foraging guide](/welcome-to-elderfield/foraging-and-resource-collection).

## Tax Collector — Every Two Weeks

After **fog weather**, a **Tax Collector** can spawn on the **road to the farm**. Payment is due on a **~two-week** cycle.

- **Farm gate** — **Tax sign** lists exact crops owed and the deadline
...
More optional tasks: [side quests index](/welcome-to-elderfield/side-quests) (Cat Snacks, Shopper Showdown, Eldritch Prank, etc.).

## World Events

Three calendar events that reshape your day:

- **Blood Moon** — full mystery reset + monster respawn ([details](/welcome-to-elderfield/moon-events))
- **Strange Moon** — Dread (-10% Ability) all day, skip bosses
- **Night Terrors** — random curses/stats lost on sleep — save first

> **Tip:** Don't sleep mid-mystery if you can't afford a bad Night Terrors roll. Pass time manually instead.

## Combat Detours

When ready — not during Strange Moon or stacked curses:

- [Uzumak, Treasure Goblin, Dripper](/welcome-to-elderfield/boss-fights-and-elites)
- [Mall vending tomes](/welcome-to-elderfield/mall-vending-machine-tomes) for buyable rituals
- [Emerald Ring](/welcome-to-elderfield/emerald-ring-from-smoffes) (+2 stat)
- [Dave's passcode lock](/welcome-to-elderfield/passcode-lock) — code TBD when confirmed
